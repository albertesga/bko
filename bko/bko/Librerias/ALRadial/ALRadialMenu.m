...
- (void)itemsWillAppearFromButton:(UIButton *) button withFrame:(CGRect)frame inView:(UIView *)view {
	...
	while (currentItem <= itemCount) {
        ...
        //He cambiado la altura del frame para que no sea un cuadrado lo suficientemente grande como para que se solape con los otros
		CGRect frame = CGRectMake(centerX-buttonSize*0.3f, centerY-buttonSize*0.3f, 50, buttonSize);
